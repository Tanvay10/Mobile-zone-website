    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by ServeTanvay Vaidya" data-placement="bottom">
                    E-Commerce Website
                </a>
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </script>,</a> Designed and Coded by Tanvay Vaidya
                </div>
            </div>
        </footer>
    </div>
